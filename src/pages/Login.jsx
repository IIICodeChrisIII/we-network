    ...
    <div className="login-container">
      ...
      <div className="login-card">
              ...
              <div className="form-row">
                <div className="input-group">
                  ...
                  <div className="input-with-icon">
                    ...
                    <input type="text" required className="input-field pl-10" placeholder="e.g. Elektrotechnik" value={degree} onChange={e => setDegree(e.target.value)} />
                  </div>
                </div>
                <div className="input-group">
        ...
        <p className="toggle-mode">
          ...
          <button type="button" className="text-accent" style={{ fontWeight: 600 }} onClick={() => setIsRegistering(!isRegistering)}>
